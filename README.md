...
시간 범위 기반으로 노트를 수집하고 회고 노트 자동 생성:
- **기간 선택**: 오늘 / 이번 주 / 이번 달
- **프로젝트 필터**: 특정 프로젝트만 필터링 가능
- **노트 목록**: 프로젝트별로 그룹화된 노트 표시
- **AI 분석**: 주요 주제, 인사이트, 다음 액션 자동 추출
- **회고 노트**: `03 Archives/Reviews/`에 자동 저장
